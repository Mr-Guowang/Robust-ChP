...
import sys
sys.path.append('/workspace/Robust-ChP/nnUNet/ChP_Net')
def get_network_from_plans(arch_class_name, arch_kwargs, arch_kwargs_req_import, input_channels, output_channels,
    ...
    if network_class == 'LWCTrans.SegmentationNetwork':
        nw_class = pydoc.locate(network_class)
        return nw_class(in_channels = input_channels,num_classes = output_channels,deep_supervision = deep_supervision)
